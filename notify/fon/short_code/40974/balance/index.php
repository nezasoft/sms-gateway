...
$SPID = '601958';//Service provider ID for Short Codes
...
$update_2 = $conn->prepare("UPDATE incoming_messages SET message='".$message."', mobile_no='".$sender."',keyword='".$activation_no."' WHERE linkid='".$linkid."' AND company_id='".$company_id."' AND service_id='".$service_id."' LIMIT 1");
$update_2->execute();
