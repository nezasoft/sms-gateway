...
//Lets invoke the getSmsDeliveryStatus to find out the status of this message and if it was delivered to the mobile subscriber
...
$delivery_status = $item->result->deliveryStatus;
//Update outgoing message status
$update_outgoing = $conn->prepare("UPDATE outgoing_messages SET delivery_status='".$delivery_status."' WHERE company_id='".$company_id."' AND short_code_id='".$short_code_id."' AND response_code='".$request_identifier."' LIMIT 1");
