<?php
/**
 * @author Walter Omedo - Frontier Optical Networks Limited -- Add New  Product Category
 * 26th Dec 2018
 */
...
$confirm = $conn->prepare("SELECT id AS cat_id FROM category WHERE category_name='".$cat_name."' ");
$confirm->execute();
$count_confirm = $confirm->rowCount();

if($count_confirm>=1){
die("<div class='alert alert-danger'>* This product category already exists in system.</div>");
}

//Lets save this record
$save = $conn->prepare("INSERT INTO category(category_name)VALUES('".$cat_name."')");
$save->execute();
