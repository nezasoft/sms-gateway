...
include("../../../connect/connect.php");
       ...
       <th>Short Code</th>
        ...
        foreach($rows as $row){
            ...
            <a href="#"  id="show_inbox_<?php  echo $row['company_short_code_id'];?>" class="btn btn-success widget-btn-2 btn-xs btn-custon-rounded-three"><i class="fa fa-envelope edu-informatio" aria-hidden="true"></i> Messages</a>
            <?php
            ...
            <a href="#" id="activate_account_<?php  echo $row['company_short_code_id'];?>" class="btn btn-success widget-btn-2 btn-xs btn-custon-rounded-three"><i class="fa fa-power-off" aria-hidden="true"></i> Start Service</a>
            <a href="#" id="deactivate_account_<?php  echo $row['company_short_code_id'];?>" class="btn btn-danger widget-btn-2 btn-xs btn-custon-rounded-three"><i class="fa fa-power-off" aria-hidden="true"></i> Stop Service</a>
