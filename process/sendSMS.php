<?php
/**
 * @author Walter Omedo - Frontier Optical Networks Limited -- This application is used to send SMS to users
 * 15th Dec 2018
 */
...
//check if its an ajax request
 if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
 	 ...
 	 $message = str_replace("'","",sanitize_string($_POST['message']));
