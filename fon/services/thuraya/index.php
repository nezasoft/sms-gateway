...
<!--<![endif]-->
<head>
	<title>Frontier Opticals Network | Thuraya  Satellite</title>
	<meta charset="utf-8">
	<!--[if IE]>
					...
					<ol class="breadcrumb full-width">
				     ...
				     <li class="breadcrumb-item">
						...
						<li class="breadcrumb-item active">
							<a href="../../services/thuraya">Thuraya Satellite</a>						</li>
					</ol>
				</section>
			</div>
						...
						<div class="offset-lg-1 col-lg-10 ">
							<div class="item-content rounded">
								<div class="rounded-image-top">
									<img src="../../images/channel/pic6.jpg" alt="Thuraya Satellite Products">								</div>
								<div class="hero-bg service-content">
									<h4>Thuraya Satellite</h4>
									<p>​Thuraya, is the mobile satellite services subsidiary of Yahsat, a leading global satellite operator based in the United Arab Emirates (UAE), fully owned by Mubadala Investment Company, the investment vehicle of the Government of Abu Dhabi. Established in 1997, Thuraya is the UAE’s first home grown satellite operator. We offer innovative communications solutions to a variety of sectors including energy, government, broadcast media, maritime, military, aerospace and humanitarian NGO.</p>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-12 col-sm-6 col-lg-3">
							<div class="channel">
								<img src="../../images/channel/thuraya.jpg" alt=""></div>
						</div>
						<!--<div class="col-12 col-sm-6 col-lg-3">
							<div class="channel">
