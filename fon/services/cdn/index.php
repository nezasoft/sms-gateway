...
<!--<![endif]-->
<head>
	<title>Frontier Opticals Network | CDN Traffic </title>
	<meta charset="utf-8">
	<!--[if IE]>
					...
					<ol class="breadcrumb full-width">
				     ...
				     <li class="breadcrumb-item">
						...
						<li class="breadcrumb-item active">
							<a href="../../services/cdn">CDN Traffic</a>						</li>
					</ol>
				</section>
			</div>
						...
						<div class="offset-lg-1 col-lg-10 ">
							<div class="item-content rounded">
								...
								<div class="hero-bg service-content">
									...
									<p>CDN is short for content delivery network. A content delivery network (CDN) is a system of distributed servers (network) that deliver pages and other web content to a user, based on the geographic locations of the user, the origin of the webpage and the content delivery server.</p>
                                      <p>
                                     This service is effective in speeding the delivery of content of websites with high traffic and websites that have global reach. The closer the CDN server is to the user geographically, the faster the content will be delivered to the user. CDNs also provide protection from large surges in traffic.
                                      </p>
									  <h4>How it works</h4>
									  <p>Servers nearest to the website visitor respond to the request. The content delivery network copies the pages of a website to a network of servers that are dispersed at geographically different locations, caching the contents of the page. When a user requests a webpage that is part of a content delivery network, the CDN will redirect the request from the originating site's server to a server in the CDN that is closest to the user and deliver the cached content. CDNs will also communicate with the originating server to deliver any content that has not been previously cached.</p>
								       <p>The process of bouncing through CDNs is nearly transparent to the user. The only way a user would know if a CDN has been accessed is if the delivered URL is different than the URL that has been requested.</p>
									   
									   <h4>Who uses a CDN </h4>
									   <p>When delivering large scale websites to a global audience, CDNs can reduce latency, accelerate site load times, reduce bandwidth consumption secure applications and even block data scrappers and other forms of spammers hitting your server.</p>
                                        <p>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-12 col-sm-6 col-lg-3">
							<div class="channel">
								<img src="../../images/channel/akamai.png" alt="">							</div>
						</div>
						<div class="col-12 col-sm-6 col-lg-3">
							<div class="channel">
								<img src="../../images/channel/google.png" alt="">							</div>
						</div>
