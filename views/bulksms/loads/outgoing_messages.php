...
include("../../../connect/connect.php");
		   ...
		   $query = $conn->prepare("SELECT om.id AS message_id  
		...
		return $setPaginate;
         ...
         $pageLimit  = ($page * $setLimit) - $setLimit;
			$query = $conn->prepare("SELECT om.id AS message_id,om.mobile_no, om.message,om.response_code,om.time_sent,om.date_sent,om.delivery_status,us.fname  
		   								 FROM outgoing_messages AS om LEFT JOIN users AS us ON us.id = om.user_id
                                  WHERE om.company_id='".$company_id."'
                                  ORDER BY om.id DESC LIMIT ".$pageLimit.",".$setLimit."");
			$query->execute();
         ...
         <div class="table-responsive ib-tb">
                                         ...
                                         <?php			
                                          ...
                                          ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="label label-info"><?php echo $row['delivery_status']; ?></span></td>
                        ...
                        <div id="PrimaryModalhdbgcl<?php  echo $row['message_id'];?>" class="modal modal-edu-general default-popup-PrimaryModal fade" role="dialog">
				            <div class="modal-dialog">
                                ...
                                <strong>Status: </strong> <?php echo $row['delivery_status']; ?><br/>
	 ...
	 <?php  
		...
		echo '<div class="alert alert-close alert-danger"><div class="alert-content"></div><font color="red"><i class="fa fa-check-circle"></i></font> You do not have any messages</div>';
...
filter = <?php  echo $filter; ?>;
	...
	var myData = 'page=' + pageno + '&filter=' + filter ;
	 jQuery.ajax({
                ...
                url: "../views/bulksms/loads/outgoing_messages.php", //Where form data is sent on submission
